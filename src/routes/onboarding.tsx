  ...
  return (
    <div className="min-h-screen bg-muted/30 py-12 px-4">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        {step === "form" && (
          <div className="rounded-2xl border border-border bg-card shadow-sm p-8 sm:p-10 space-y-8">
            ...
            <form onSubmit={handleGenerate} className="space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select defaultValue="Coffee Shop">
                    ...
                    <SelectContent>
                      {["Bakery", "Restaurant", "Electronics", "Clothing", "Coffee Shop", "Other"].map((o) => (
                ...
                <div className="space-y-2">
                  ...
                  <Select defaultValue="Friendly">
                    <SelectTrigger><SelectValue /></SelectTrigger>
                    <SelectContent>
                      {["Professional", "Friendly", "Premium", "Fun"].map((o) => (
                        <SelectItem key={o} value={o}>{o}</SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="Instagram">
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    {["Instagram", "Facebook", "WhatsApp"].map((o) => (
                      <SelectItem key={o} value={o}>{o}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
        ...
        {step === "loading" && (
          <div className="rounded-2xl border border-border bg-card shadow-sm p-16 text-center space-y-4">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    <div key={p.c} className="flex-1 space-y-1.5">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Warm", "Considered", "Approachable", "Crafted", "Confident"].map((t) => (
                    <span
                      key={t}
